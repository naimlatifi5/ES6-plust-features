export const variableScopingLetConst = () => {
  /********************************************
  ...
  console.log(
    '************ Create functions with arrays, compared ES5 and ES6 solution **********',
  );
  // example with let inside for loop block level --- uncomment code below, it is commented due to warnings in console
  ...
  // var ff = createThreeFunctionInArray();
  // ff[0]();
  // ff[1]();
  // ff[2]();
};
